<div class="form-grid">
 ...
 <label>Contraseña {{ $user?'(opcional)':'' }}<input type="password" name="password" {{ $user?'':'required' }} minlength="12" autocomplete="new-password"><small>Mínimo 12 caracteres, con mayúsculas, minúsculas y números.</small></label>
