<div class="form-grid">
 ...
 <label>Unidad de la etiqueta<select name="label_unit" required><option value="units" @selected(old('label_unit',$product->label_unit)==='units')>Unidades</option><option value="kg" @selected(old('label_unit',$product->label_unit)==='kg')>Kilogramos (KG)</option></select><small>Define el texto que se imprime junto a la cantidad.</small></label>
