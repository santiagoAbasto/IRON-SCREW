...
@if(in_array('products.view',$ironUser->role?->permissions??[]))<a href="{{ route('settings.products') }}"><i><img src="{{ asset('assets/figma/settings-circle.svg') }}" alt=""><img src="{{ asset('assets/figma/settings-products.svg') }}" alt=""></i><h2>Productos</h2><p>Ver catálogo e imprimir etiquetas</p></a>@endif
</div>
@endsection
