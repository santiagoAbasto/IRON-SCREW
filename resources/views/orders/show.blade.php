...
@endif
<dialog class="form-dialog label-dialog" id="label-dialog-{{ $item->id }}" data-label-dialog data-code="{{ $item->code }}" data-description="{{ $item->description }}" data-quantity="{{ $quantity }}" data-fractioned="{{ $fractioned }}" data-bulk="{{ $bulk }}" data-customer="{{ $order->customer }}" data-order="{{ $order->number }}" data-logo="{{ asset('assets/figma/label-logo.png') }}">
