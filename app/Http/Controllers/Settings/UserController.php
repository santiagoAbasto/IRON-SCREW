...
class UserController extends Controller
{
    ...
    {
        $data = $request->validate(['name' => 'required|max:255', 'username' => 'required|max:100|unique:users', 'email' => 'required|email|unique:users', 'password' => ['required', Password::min(12)->mixedCase()->numbers()], 'role_id' => 'nullable|exists:roles,id', 'is_active' => 'nullable|boolean']);
