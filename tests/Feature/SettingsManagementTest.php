...
class SettingsManagementTest extends TestCase
{
    ...
    public function test_admin_can_manage_products_users_roles_and_permissions(): void
    {
        ...
        $this->withSession($session)->post(route('settings.users.store'),['name'=>'Operador Uno','username'=>'operador','email'=>'operador@example.com','password'=>'secret1','role_id'=>$operator->id,'is_active'=>1])->assertRedirect();
